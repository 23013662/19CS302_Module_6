...
2.Allocate memory for emp1, emp2, and emp3 using malloc().

3.Assign values to employee attributes and link managers.
...
## Output:
![image](https://github.com/user-attachments/assets/ca31cdf9-6392-4bd7-b744-f4587344b2eb)
